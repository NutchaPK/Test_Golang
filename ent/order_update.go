...
func (ou *OrderUpdate) SetPaidDate(t time.Time) *OrderUpdate {
	ou.mutation.SetPaidDate(t)
	return ou
}

// SetNillablePaidDate sets the "PaidDate" field if the given value is not nil.
func (ou *OrderUpdate) SetNillablePaidDate(t *time.Time) *OrderUpdate {
	if t != nil {
		ou.SetPaidDate(*t)
	}
	return ou
...
func (ou *OrderUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ou.mutation.PaidDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
...
// SetPaidDate sets the "PaidDate" field.
func (ouo *OrderUpdateOne) SetPaidDate(t time.Time) *OrderUpdateOne {
	ouo.mutation.SetPaidDate(t)
	return ouo
}

// SetNillablePaidDate sets the "PaidDate" field if the given value is not nil.
func (ouo *OrderUpdateOne) SetNillablePaidDate(t *time.Time) *OrderUpdateOne {
	if t != nil {
		ouo.SetPaidDate(*t)
	}
	return ouo
...
func (ouo *OrderUpdateOne) sqlSave(ctx context.Context) (_node *Order, err error) {
	...
	if value, ok := ouo.mutation.PaidDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: order.FieldPaidDate,
