...
func (oc *OrderCreate) SetPaidDate(t time.Time) *OrderCreate {
	oc.mutation.SetPaidDate(t)
	return oc
}

// SetNillablePaidDate sets the "PaidDate" field if the given value is not nil.
func (oc *OrderCreate) SetNillablePaidDate(t *time.Time) *OrderCreate {
	if t != nil {
		oc.SetPaidDate(*t)
	}
	return oc
...
func (oc *OrderCreate) defaults() {
	if _, ok := oc.mutation.PaidDate(); !ok {
		v := order.DefaultPaidDate()
		oc.mutation.SetPaidDate(v)
	}
}
...
func (oc *OrderCreate) check() error {
	...
	if _, ok := oc.mutation.ShippingAddress(); !ok {
		return &ValidationError{Name: "ShippingAddress", err: errors.New(`ent: missing required field "Order.ShippingAddress"`)}
	}
	if _, ok := oc.mutation.PaidDate(); !ok {
		return &ValidationError{Name: "PaidDate", err: errors.New(`ent: missing required field "Order.PaidDate"`)}
	}
	return nil
}
...
func (oc *OrderCreate) createSpec() (*Order, *sqlgraph.CreateSpec) {
	...
	if value, ok := oc.mutation.PaidDate(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: order.FieldPaidDate,
		})
